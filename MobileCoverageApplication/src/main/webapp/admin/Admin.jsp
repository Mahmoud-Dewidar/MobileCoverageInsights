...
<%@ page import="java.util.List" %><%-- Created by IntelliJ IDEA. User: DEWIDAR Date: 4/9/2023 Time: 7:42 AM To change this template use File | Settings |
    File Templates. --%>
...
<div class="headerrr">
    <h1 style="font-family:  'Dancing Script','Poppins'; font-size: 47px;font-weight:600;">
        Welcome in Mobile Coverage Insights</h1>
</div>
        ...
        <div class="col-xl-3 col-xxl-3 col-sm-4">
            <div class="card bg-warning invoice-card">
                <div class="card-body d-flex">
                    ...
                    <div>
                        <h2 class="text-white invoice-num"><%=conn.noOfCountries() %></h2>
                        <span class="text-white fs-18">Total Countries</span>
                    </div>
                </div>
            </div>
        </div>
        <div class="col-xl-3 col-xxl-3 col-sm-6">
            <div class="card bg-success invoice-card">
                <div class="card-body d-flex">
                    ...
                    <div>
                        <h2 class="text-white invoice-num"><%= conn.noOfCells() %></h2>
        ...
        <div class="col-xl-3 col-xxl-3 col-sm-6">
            <div class="card bg-info invoice-card">
                <div class="card-body d-flex">
                    ...
                    <%
                        int noOfOperators = conn.noOfOperators();
                    %>
                    <div>
                        <h2 class="text-white invoice-num">4
                        </h2>
                        <span class="text-white fs-18">Total Operators</span>
                    </div>
                </div>
            </div>
        </div>
...
<script>
    function initMap() {
        ...
        <% List<Point> pointsList = conn.getCoordinates2();
        String lat ;
        String lon ;
        ...
        if (pointsList != null) {
            for (Point point : pointsList) {
                if(point.getLatitude() != null && point.getLatitude() != null && point.getSignalStrength() != null){
        ...
        %>
        points.push({lat: <%= lat %>, lon: <%= lon %>, signalStrength: <%= signalStrength %>, city: "<%= city %>", operator: "<%= operator %>"});
        <% } } %>
        console.log(points)
        ...
        points.forEach(function (point) {
            let x;
            if (point.operator.toLowerCase() === "vodafone") {
                x = redIcon
            }else if (point.operator.toLowerCase() === "orange") {
                x = orangeIcon
            }else if (point.operator.toLowerCase() === "we" || point.operator.toLowerCase() === "telecom egypt"){
                x = violetIcon
            }else if (point.operator.toLowerCase() === "etisalat by e&"){
                x = blackIcon
            }
            point.iconn = x
        })
        ...
        points.forEach(function (point) {
            // Create the marker
            console.log(point)
            var marker =     L.marker([point.lon, point.lat],{icon : point.iconn}).addTo(map);
