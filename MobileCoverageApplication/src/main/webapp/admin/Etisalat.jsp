...
<div class="vodafone" style="width: 23%; ">
    <img src="images/Screenshot%202023-06-30%20004142.png" height="50px" width="50px" style="border-radius: 10px">
    <h1
            style="font-family:  'Dancing Script','Poppins'; font-size: 47px;font-weight:600; color: #333333; padding-left: 10px;">
        Etisalat Egypt</h1>
</div>
...
<div class="handset">
    ...
    <div class="handsetInfo">
        <h3 class="info" style="color: rgb(4, 92, 164);">SAMSUNG: <%= conn.noOfPhoneType("etisalat by e&","samsung") %></h3>
        <h3 class="info" style="color: rgb(3, 105, 3); ">OPPO: <%= conn.noOfPhoneType("etisalat by e&","oppo") %></h3>
        <h3 class="info" style="color: rgb(154, 4, 4);">HUAWEI: <%= conn.noOfPhoneType("etisalat by e&","huawei") %></h3>
        <h3 class="info" style="color: rgb(229, 151, 6);">REALME: <%= conn.noOfPhoneType("etisalat by e&","realme") %></h3>
        <h3 class="info" style="color: rgb(183, 164, 0);">XIAOMI: <%= conn.noOfPhoneType("etisalat by e&","xiaomi") %></h3>
        ...
        <div class="col-xl-3 col-xxl-3 col-sm-4">
            <div class="card bg-warning invoice-card">
                <div class="card-body d-flex">
                    ...
                    <div>
                        <h2 class="text-white invoice-num"><%=conn.noOfCitiesByOperator("etisalat by e&")%></h2>
        ...
        <div class="col-xl-3 col-xxl-3 col-sm-6">
            <div class="card bg-success invoice-card">
                <div class="card-body d-flex">
                    ...
                    <div>
                        <h2 class="text-white invoice-num"><%=conn.noOfCellsByOperator("etisalat by e&")%></h2>
...
<script>
    function initMap() {
        ...
        <% List<Point> pointsList = conn.getPointsByOperator("etisalat by e&");
        String lat;
        String lon;
        ...
        points.forEach(function (point) {
            // Create the marker
            var marker = L.marker([point.lon, point.lat],{ icon: blackIcon }).addTo(map);
...
<script>
    ...
    var chart = new Chart(ctxx, {
        ...
        data: {
            ...
            datasets: [{
                data: [<%=conn.getPowerPercentage("etisalat by e&","100","70")%>, <%=conn.getPowerPercentage("etisalat by e&","70","40")%>, <%=conn.getPowerPercentage("etisalat by e&","40","0")%>],
