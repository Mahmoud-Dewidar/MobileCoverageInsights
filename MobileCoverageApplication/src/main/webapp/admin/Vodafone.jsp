...
<div class="vodafone" style="width: 23%; ">
    <img src="https://icons.iconarchive.com/icons/martz90/circle-addon1/128/vodafone-icon.png" width="50"
         height="50">
    <h1
            style="font-family:  'Dancing Script','Poppins'; font-size: 47px;font-weight:600; color: #cd1d06; padding-left: 10px;">
        Vodafone Egypt</h1>
</div>
...
<div class="handset">
    ...
    <div class="handsetInfo">
        <h3 class="info" style="color: rgb(4, 92, 164);">SAMSUNG: <%= conn.noOfPhoneType("vodafone", "samsung") %>
        </h3>
        <h3 class="info" style="color: rgb(3, 105, 3); ">OPPO: <%= conn.noOfPhoneType("vodafone", "oppo") %>
        </h3>
        <h3 class="info" style="color: rgb(154, 4, 4);">HUAWEI: <%= conn.noOfPhoneType("vodafone", "huawei") %>
        </h3>
        <h3 class="info" style="color: rgb(229, 151, 6);">REALME: <%= conn.noOfPhoneType("vodafone", "realme") %>
        </h3>
        <h3 class="info" style="color: rgb(183, 164, 0);">XIAOMI: <%= conn.noOfPhoneType("vodafone", "xiaomi") %>
        </h3>
        ...
        <div class="col-xl-3 col-xxl-3 col-sm-4">
            <div class="card bg-warning invoice-card">
                <div class="card-body d-flex">
                    ...
                    <div>
                        <h2 class="text-white invoice-num"><%=conn.noOfCitiesByOperator("vodafone")%>
                        </h2>
        ...
        <div class="col-xl-3 col-xxl-3 col-sm-6">
            <div class="card bg-success invoice-card">
                <div class="card-body d-flex">
                    ...
                    <div>
                        <h2 class="text-white invoice-num"><%=conn.noOfCellsByOperator("vodafone")%>
                        </h2>
...
<script>
    function initMap() {
        ...
        <% List<Point> pointsList = conn.getPointsByOperator("Vodafone");
        String lat;
        String lon;
        ...
        points.forEach(function (point) {
            // Create the marker
            var marker = L.marker([point.lon, point.lat], {icon: redIcon}).addTo(map);
...
<script>
    ...
    var chart = new Chart(ctxx, {
        ...
        data: {
            ...
            datasets: [{
                data: [<%=conn.getPowerPercentage("vodafone","100","70")%>, <%=conn.getPowerPercentage("vodafone","70","40")%>, <%=conn.getPowerPercentage("vodafone","40","0")%>],
